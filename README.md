...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0,0);
  Lcd_string(&lcd, "MONISH N\n");
  Lcd_cursor(&lcd, 1,2);
  Lcd_string(&lcd, "212223240097");
  HAL_Delay(500);
  while(1){}
}
void SystemClock_Config(void)
...
![WhatsApp Image 2024-04-02 at 16 16 11_c8010184](https://github.com/Monishofficial/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/149455421/ea6c5aa7-001b-4fae-b2f3-630f71e7301a)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

![image](https://github.com/Monishofficial/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/149455421/1f8f34c0-ae63-438d-a9ec-ffc1ff536d12)
